...
public class DbJoinImporter(ImporterConfig config) : BaseImporter(config)
{
    ...
    public override string ImporterName => "Join";
    ...
    private void ProcessImportLines()
    {
        ...
        {
            var batchLines = _repository.GetImportLinesByJoin(_jobId, ItemBatchSize);
